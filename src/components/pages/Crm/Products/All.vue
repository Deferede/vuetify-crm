<template>
    ...
    >
        ...
        <template #item.active="{ item }">
            <active-chip :active="item.active"></active-chip>
        </template>
        <template #item.actions="{ item }">
            <v-btn icon  :to="{name: `Edit product`, params: {id: item.id}}">
...
<script>
    ...
    import ActiveChip from "../../../partials/mini_componens/ActiveChip";
    ...
    export default {
        ...
        methods: {
            ...mapActions({
                ...
                destroyItem: "products/deleteItem"
            }),
            deleteItem(id) {
